...
public class PhotoIntentActivity extends Activity {
	...
	private File createImageFile() throws IOException {
		...
		pic_cnt++;
		String imageFileName = JPEG_FILE_PREFIX + pic_cnt + (int)(valuesResult[0]) + "_" + (int)(valuesResult[1])+ "_" + (int)(valuesResult[2]) + "_";
	...
	private void handleBigCameraPhoto() {
		...
		if (mCurrentPhotoPath != null) {
			setPic();
			galleryAddPic();
            TextView debug_tvText = (TextView) findViewById(R.id.textView2);
            debug_tvText.setText(mCurrentPhotoPath);
			mCurrentPhotoPath = null;

		}else{
//			TextView debug_tvText = (TextView) findViewById(R.id.textView2);
//			debug_tvText.setText("error");
		}
